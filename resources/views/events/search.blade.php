            ...
            <div class="col-lg-8">
                <h1 class="display-5 mb-3">
                    ...
                    @elseif(request('keyword'))
                        Search Results for <span class="search-highlight">"{{ request('keyword') }}"</span>
                    @elseif(request('date'))
                        Events on {{ \Carbon\Carbon::parse(request('date'))->format('F d, Y') }}
                    @else
                        Search Results
                    @endif
                </h1>
                <p class="text-muted">
                    @if(request('keyword') || request('type') || request('date'))
        ...
        <form action="{{ route('events.search') }}" method="GET">
            <div class="row g-3">
                ...
                <div class="col-lg-1 col-md-1">
                    <a href="{{ route('events.search') }}" class="btn btn-outline-primary d-flex align-items-center justify-content-center">
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="alert bg-light border-0">
                <i class="fas fa-info-circle me-2 text-primary"></i> No events found matching your search criteria.
            </div>
